...
(function($){
  ...
  $.fn.extend({ 
    ...
    newsTicker: function(options) {
       ...
       * 
       *  jQuery 1.3.2 or higher needed for this script to run.  
       *  
       ...
       * });
       */
      var version = parseInt($().jquery.replace(/\./gi, ''));
      if (version >= 132) {
        var defaults = {
          showTime: 5000,
        ...
        alert('The plugin can\'t work. You\'ve got a wrong jQuery version. Version 1.3.2 or higher is required to run this plugin. Please download the latest at www.jquery.com');
      }
